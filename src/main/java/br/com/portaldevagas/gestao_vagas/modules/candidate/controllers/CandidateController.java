...
import br.com.portaldevagas.gestao_vagas.modules.candidate.dto.ProfileCandidateResponseDTO;
...
import br.com.portaldevagas.gestao_vagas.modules.candidate.useCases.ListAllJobsByFilterUseCase;
import br.com.portaldevagas.gestao_vagas.modules.candidate.useCases.ProfileCandidateUseCase;
import br.com.portaldevagas.gestao_vagas.modules.company.entities.JobEntity;
...
public class CandidateController {
  ...
  @GetMapping("/job")
  @PreAuthorize("hasRole('CANDIDATE')")
  @Operation(summary = "Listagem de vagas disponível para o candidate", description = "Essa função é responsável por listar todas as vagas disponíveis, baseada no filtro")
  @ApiResponses({
      @ApiResponse(responseCode = "200", content = {
